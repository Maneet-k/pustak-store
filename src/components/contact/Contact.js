        ...
        <div className={'contact-page'}>
            <div className={'contact-card'}>
                <div className={'email-logo'}>
                   <EmailIcon style={{fontSize:'50px',color:'#373a47'}}/>
                </div>
                {message!==''
                ?
                <div style={{marginTop:'20px',textAlign:'center'}}>
                    <text style={{fontSize:'22px',color:'black'}}>Thanks for sending message, we will contact you soon!!</text>
                </div>
                :null
                }
                <div className={'form-container'}>
                    <form className={classes.root}>
                      <TextField
                        ...
                        <Button onClick={()=>handleMail()} variant="contained" color="primary" style={{backgroundColor:'rgb(90,90,90)',paddingBlock:"8px",fontSize:"15px"}} disableElevation>
                            send Message
                        </Button>
                        </div>
                    </form>               
